...
class StaticMethods(object):
    ...
    @staticmethod
    # def parse_time(bajt1, bajt2, bajt3, bajt4):
    ...
    def iterate_and_find(frame):
        ...
        for i,element in enumerate(frame):
            if int_all_exist:
                int_all, int_all_exist = StaticMethods.flow_all(element,i,frame)
            if int_avg_exist:
                int_avg, int_avg_exist = StaticMethods.flow_avg(element,i,frame)
            else:
                break
...
if __name__ == '__main__':
    ...
    print("%r" %table)
    print("%r" %table_int)
    print (StaticMethods.iterate_and_find(table_int) )
